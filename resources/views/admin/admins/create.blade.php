...
<div class="row">
			<div class="col-md-12">
				...
				@endif
				<form action="{{aurl('admin/add')}}" method="post" enctype="multipart/form-data" >
				{{csrf_field()}}
				<!--begin::Portlet-->
						...
						<div class="m-form m-form--fit m-form--label-align-right" >
							<div class="m-portlet__body">
								...
								<div class="form-group m-form__group">
									...
									<input type="text" class="form-control m-input" id="exampleInputPassword1" placeholder=""  name="name" value="{{old('name')}}">
								</div>
								<div class="form-group m-form__group">
									<label for="exampleInputPassword1">
										@lang('admin.email')
									</label>
									<input type="text" class="form-control m-input" id="exampleInputPassword1" placeholder=""  name="email" value="{{old('email')}}">
								</div>
								<div class="form-group m-form__group">
									<label for="exampleInputPassword1">
										@lang('admin.password')
