...
<link href="https://getbootstrap.com/docs/4.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container d-flex justify-content-between">
      ...
      <a href="{{url('logout')}}" class="navbar-toggler"> logout</a>
      <div class="dropdown">
...
<main role="main">
  ...
  <section class="jumbotron text-center">
    <div class="container">
      <h1 class="jumbotron-heading">@lang('admin.Products')</h1>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="card mb-4 shadow-sm">
            <img src="{{url('upload/'.$product->image)}}" class="bd-placeholder-img card-img-top" width="100%" height="225" >
            <div class="card-body">
              <h3>{{$product->{'name:'.app()->getLocale()} }}</h3>
              <p class="card-text">{{$product->{'desc:'.app()->getLocale()} }}</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  
                </div>
                <small class="text-muted">{{$product->{'price:'.app()->getLocale()} }}</small>
              </div>
            </div>
          </div>
        </div>
